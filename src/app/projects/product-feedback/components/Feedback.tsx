  ...
  return (
    <>
      {productRequests.length === 0 && (
        ...
        <div className="bg-white text-[13px] rounded-[10px] p-6 flex flex-col gap-2 " key={i}>
      ...
      {productRequests && (
        <div className="bg-white flex flex-col items-center rounded-[10px] py-[76px] px-6">
            ...
            <h2 className="text-[18px] mt-10 mb-4 font-bold text-[#3A4374]">There is no feedback yet.</h2>
            <p className="text-[13px] mb-6 text-[#647196] text-center">Got a suggestion? Found a bug that needs to be squashed? We love hearing about new ideas to improve our app.</p>
