...
const Page = () => {
  return (
    <div
      className="absolute left-1/2 mt-52 -translate-x-1/2 "
      style={{
        background: "#140e66b2",
        borderRadius: "48px",
      ...
      >
        <div className="relative -mt-12 text-3xl uppercase text-white sm:-mt-24 sm:text-4xl">
          ...
          <div className="relative capitalize">
            ...
            <h4 className="gradient-text absolute top-0 text-8xl sm:text-9xl">
              hangman
            </h4>
          </div>
        ...
        <Link href="/projects/hangman-game/category">
          ...
          >
            <div
              className="pink-gradient flex h-40 w-40 items-center justify-center rounded-full sm:h-52 sm:w-52"
              style={{
            ...
            >
              <Image
                ...
                height={50}
                width={52}
                className="h-12 w-14 sm:h-[62px] sm:w-16"
              />
            </div>
          </div>
        </Link>
