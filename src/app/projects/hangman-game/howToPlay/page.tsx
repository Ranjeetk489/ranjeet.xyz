      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-8 mt-[60px] space-y-8 items-stretch lg:space-y-0">
          <div className="bg-white px-6 py-8 md:px-12 md:py-[60px] lg:px-10  rounded-3xl tracking-wider lg:flex lg:flex-col lg:gap-8 desc-card">
            <p className="text-blue text-2xl md:text-hl text-center md:col-start-1 md:col-end-1 md:row-start-1 md:row-end-3 md:self-center justify-self-start lg:mb-10">01</p>
            <p className="text-2xl text-start text-dark-navy uppercase lg:text-hm lg:text-center">Choose a category</p>
          ...
          <div className="bg-white px-6 py-8 md:px-12 md:py-[60px] lg:px-10  rounded-3xl tracking-wider lg:flex lg:flex-col lg:gap-8 desc-card">
            <p className="text-blue text-2xl md:text-hl text-center md:col-start-1 md:col-end-1 md:row-start-1 md:row-end-3 md:self-center justify-self-start lg:mb-10">02</p>
            <p className="text-2xl text-start text-dark-navy uppercase lg:text-hm lg:text-center">Guess the letters</p>
            <p className="text-[#887DC0] text-base md:text-b leading-[150%] lg:mt-6 lg:text-center row-start-2 row-end-3 col-start-1 col-end-3 md:col-start-2 md:col-end-3 mt-2">
          ...
          <div className="bg-white px-6 py-8 md:px-12 md:py-[60px] lg:px-10  rounded-3xl tracking-wider lg:flex lg:flex-col lg:gap-8 desc-card">
            <p className="text-blue text-2xl md:text-hl text-center md:col-start-1 md:col-end-1 md:row-start-1 md:row-end-3 md:self-center justify-self-start lg:mb-10">01</p>
            <p className="text-2xl text-start text-dark-navy uppercase lg:text-hm lg:text-center">WIN OR LOSE</p>
            <p className="text-[#887DC0] text-base md:text-b leading-[150%] lg:mt-6 lg:text-center row-start-2 row-end-3 col-start-1 col-end-3 md:col-start-2 md:col-end-3 mt-2">
